...
const totalPrice = orderItems.reduce((sum, item) => sum + item.amount * item.quantity, 0);
          ...
          <div className="flex flex-col gap-2 max-h-[200px] overflow-auto">
            {orderItems.length === 0 ? (
              ...
              orderItems.map((item, index) => (
                <div key={index} className="flex justify-between items-center text-sm border-b py-1">
                  <span>
