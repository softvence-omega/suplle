    ...
    <div>
      <div className="bg-white min-h-screen">
        ...
        <header className="fixed w-full z-30 flex transform ease-in-out duration-500 bg-green-100 dark:bg-primary-dark  p-2 items-center justify-between h-16 px-10">
          ...
          {/* input field */}
          <div className="hidden md:flex w-full max-w-[438px] h-[40px] px-[14px] py-[8px] items-center gap-[16px] rounded-[8px] bg-[#F6F8FB] border dark:border-white dark:bg-primary-dark relative">
            <input
              type="text"
        ...
        <main
          ...
          } transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 dark:bg-secondary-dark min-h-screen`}
        >
