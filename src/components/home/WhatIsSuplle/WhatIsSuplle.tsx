    ...
    <div className="py-10 bg-white overflow-hidden">
      ...
      >
        <motion.h2
          ...
          className="text-primary-dark text-3xl sm:text-4xl lg:text-6xl text-center font-bold"
        >
          🚀 What is <span className="text-primary-gradient">Suplle?</span>
        </motion.h2>

        <motion.p
          className="text-center mt-6 text-lg sm:text-xl lg:text-2xl text-gray-700"
          variants={itemVariants}
        >
