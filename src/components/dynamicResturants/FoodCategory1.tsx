...
const foodCategoryData1 = [
    { id: generateRandomId(), name: 'Starters', url: '/starter', value: 'Starters' },	
    { id: generateRandomId(), name: 'Main Course', url: '/main-course', value: 'Main Course' },
    { id: generateRandomId(), name: 'Soft Drinks', url: '/soft-drinks', value: 'Soft Drinks' }
    ]  
    type Props = {
      selectedCategory: string
      setSelectedCategory: (value: string) => void
    }    
const FoodCategory1: React.FC<Props> = ({ selectedCategory, setSelectedCategory }) => {
  return (
    <Wrapper>
