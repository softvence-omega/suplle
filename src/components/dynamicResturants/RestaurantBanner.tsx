...
const RestaurantBanner = () => {
  return (
    ...
    >
      <div className="flex flex-col px-5 md:flex-row justify-between items-center bg-white/90 p-6 md:p-10 rounded-2xl shadow-lg">
        {/* Left Section */}
        <div className="flex-1 space-y-4">
          <p className="text-xl text-[#03081F] font-normal">I'm loving' it!</p>
          <h2 className="text-5xl font-semibold text-[#03081F]">Urban Bistro Menu</h2>
        ...
        <div className="relative mt-10 md:mt-0 md:ml-8">
          ...
          <div className="absolute -bottom-3 -left-6 bg-white px-4 py-2 rounded-xl shadow-md text-center">
            <p className="text-6xl font-bold">3.4</p>
