      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 mb-4">
            Whether you’re looking to enjoy a casual meal with friends, celebrate a special occasion, or grab a quick bite, Urban Bistro is the perfect place.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-400">
            <li><a href="#" className="hover:text-white">Restaurant Menu</a></li>
            <li><a href="#" className="hover:text-white">Starter Items</a></li>
            <li><a href="#" className="hover:text-white">Main Course</a></li>
          </ul>
        </div>
