...
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.65476 0.839288L3.57995 6.70199L1.96792 4.97966C1.67097 4.69968 1.20433 4.68271 0.864951 4.92027C0.53406 5.16632 0.440732 5.59902 0.644357 5.94688L2.55334 9.05216C2.74 9.34063 3.0624 9.5188 3.42723 9.5188C3.77509 9.5188 4.10598 9.34063 4.29264 9.05216C4.59808 8.6534 10.4268 1.70469 10.4268 1.70469C11.1904 0.924131 10.2656 0.236897 9.65476 0.830803V0.839288Z" fill="currentColor"/>
  ...
  {/* Dark Mode Button */}
  <button className="w-full px-4 py-2 bg-[#030303] text-white rounded-md md:text-base text-sm hidden dark:block">
    Get started
  </button>
</div>
