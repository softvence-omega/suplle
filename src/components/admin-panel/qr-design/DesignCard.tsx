  ...
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden transition-all duration-200 hover:shadow-md md:p-6 p-2 dark:bg-[#161616] ">
      <div className="flex justify-center items-center py-[10px]">
        <img src={design.imageUrl} alt={design.name} className='h-[100px] w-[100px]' />
      </div>
      ...
      <div className=" flex flex-col gap-2 ">
        ...
        <h3 className="text-[20px] font-normal text-[#565656] dark:text-white text-center">{design.name}</h3>
        <p className=" text-sm text-[#667085] dark:text-white font-normal line-clamp-2 text-center">{design.description}</p>
